...
`))
	...
	require.Equal(t, upstream.requests[0].Header.Get("session-id"), upstream.requests[0].Header.Get("session_id"))
	require.NotEmpty(t, upstream.requests[0].Header.Get("thread-id"))
	require.Equal(t, upstream.requests[0].Header.Get("thread-id"), upstream.requests[0].Header.Get("x-client-request-id"))
